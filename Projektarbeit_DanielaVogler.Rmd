...
```{r cart model results ds1, include = TRUE, fig.cap="Entscheidungsbaum und Variablenwichtigkeit Baseline-Datensatz"}
...
```{r caret cart model ds1 preprocessed}
# set.seed(12345)
# 
...
```{r cart model results ds2, include = TRUE, fig.cap="Entscheidungsbaum und Variablenwichtigkeit Onset-Datensatz"}
...
```{r cart model results ds3, include = TRUE, fig.cap="Entscheidungsbaum und Variablenwichtigkeit Regressionsdatensatz"}
...
```{r caret cart model ds3 preprocessed}
# set.seed(12345)
...
```{r resamples statistics, include = TRUE}
