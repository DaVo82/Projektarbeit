...
einem (beginnenden) Organversagen stehen können. Inwieweit sich hieraus allgemein
anwendbare Entscheidungsregeln ableiten lassen, ist aber fraglich, zumal
Veränderungen dieser Werte auch im Kontext mit Vor- und Begleiterkrankungen
beurteilt werden müssen. So ist beispielsweise eine Änderung des Glukosewerts bei
einem Diabetiker anders zu beurteilen als bei einem Nicht-Diabetiker.
