...
Die nachfolgenden Plots stellen die Variablenwichtigkeit der einzelnen Modelle dar.
Dabei erhält die jeweils wichtigste Variable eine Score von 100 und die weiteren 
Variablen werden in Relation dazu bewertet. Kriterium ist die Verbesserung des
Gini-Unreinheitsmaßes.
...
muss der Intensivaufenthalt natürlich nicht kausal für die Erkrankung sein. 
...
intepretiert werden: Wer sehr schnell (innerhalb der ersten eineinhalb Stunden)
...
[TOP-Modelle gesondert angucken
Random Forest: Korrelation EtCo2 + Bilirubin (über direkt) -> plot_predict_interaction.caret_ranger(rf_ds3$finalModel,ds3_imputed, 
                                      "slope_Bilirubin_total", "slope_EtCO2")
Funktion und Package erklären

GBM: 

Korrelationen angucken

Was bedeutet das Bilirubin im Random Forest nach Imputation beim Onset-Ansatz?
