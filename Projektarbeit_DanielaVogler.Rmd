...
testen (d. h. Daten aus einem anderen Krankenhaus und möglichst auch anderem
Quellsystem) ausprobieren. Wir greifen hier auf unsere eingangs abgespalteten 
Testdatensätze mit 25 % der Beobachtungen des ursprünglichen Samples zurück - in 
dem Bewusstsein, dass diese aus den gleichen Datenquellen stammen wie unsere
Trainingsdaten. Wir erhalten folgende Konfusionsmatrizen:
...
binary_visualiseR(train_labels = pred_rf_ds1,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (imp.) Baseline",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
binary_visualiseR(train_labels = pred_rf_nm_ds1,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (non-mis.) Baseline",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
binary_visualiseR(train_labels = pred_rf_ds2,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (imp.) Onset",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
binary_visualiseR(train_labels = pred_rf_nm_ds2,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (non-mis.) Onset",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
binary_visualiseR(train_labels = pred_rf_ds3,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (imp.) Regression",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
binary_visualiseR(train_labels = pred_rf_nm_ds3,
                               ...
                               class_label1 = "positiv", 
                               class_label2 = "negativ",
                               custom_title = "Random Forest (non-mis.) Regression",
                               info_box_title = "Statistik",
                               text_col = "black")
dev.off()
...
```{r confusion matrix plots1, include = TRUE, fig.cap="Konfusionsmatrizen"}
grid.arrange(cf_table1, cf_table2, cf_table3, cf_table4, cf_table5, cf_table6,
             ncol = 2, nrow = 3)
```

```{r confusion matrix plots2, include = TRUE, fig.cap="Konfusionsmatrizen (Fortsetzung)"}
grid.arrange(cf_table7, cf_table8, cf_table9, cf_table10, cf_table11, cf_table12,
             ncol = 2, nrow = 3)
```
