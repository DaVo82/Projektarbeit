...
by_patient <- data_sub %>% 
  ...
  unnest(c(slope_HR, slope_O2Sat, slope_Temp, slope_SBP, slope_MAP, slope_DBP, 
           ...
           slope_Bilirubin_direct, slope_Glucose, slope_Lactate, slope_Magnesium, 
           slope_Phosphate, slope_Potassium, slope_Bilirubin_total, slope_TroponinI, 
           slope_Hct, slope_Hgb, slope_PTT, slope_WBC, slope_Fibrinogen, 
           slope_Platelets)) %>%  
  select(-data)
